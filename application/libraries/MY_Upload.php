...
class MY_Upload extends CI_Upload {
    ...
    public function get_data($index = null) {
        $data = array(
            ...
            'attach_path'    => $this->attach_dir . $this->get_target_dir($this->folder_type) . $this->file_name,
            'thumbnail_name' => $this->thumbnail_name,
            'thumbnail_path' => $this->thumbnail_name ? $this->attach_dir . $this->get_target_dir($this->folder_type) . $this->thumbnail_name : '',
